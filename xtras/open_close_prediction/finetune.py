# -*- coding: utf-8 -*-
"""Copy of finetuning.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1QvWlBxyxwL1KAktABvoPVtZifGHKCUkg
...
# Use hub.load instead of hub.Module to load the model.
module = hub.load(hub_path)
key = module.signatures['default'](x['image'])
...
fig, axes = plt.subplots(20, 1, figsize=(15, 15))
for i in range(20):
